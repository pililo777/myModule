...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/_ext/626565074/myModule.o
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../ejemplos/libmyModule.so

../ejemplos/libmyModule.so: ${OBJECTFILES}
	${MKDIR} -p ../ejemplos
	${LINK.c} -o ../ejemplos/libmyModule.so ${OBJECTFILES} ${LDLIBSOPTIONS} -shared

${OBJECTDIR}/_ext/626565074/myModule.o: nbproject/Makefile-${CND_CONF}.mk /cygdrive/C/Users/test/Documents/NetBeansProjects/myModule/myModule.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/626565074
	${RM} "$@.d"
	$(COMPILE.c) -g -I/cygdrive/D/GTK/lib/gtk-2.0/include -I/cygdrive/D/GTK/include/gtk-2.0 -I/cygdrive/c/cygwin/usr/include/libgnomeui-2.0 -I/cygdrive/c/cygwin/usr/include -I/usr/include/libgnomeui-2.0 -I/usr/include -I/usr/lib/gcc/i686-pc-cygwin/4.8.3/include-fixed -I/usr/lib/gcc/i686-pc-cygwin/4.8.3/include/c++ -I/usr/x86_64-pc-cygwin/sys-root/usr/include -I/cygdrive/c/cygwin/usr/include/libgnomecanvas-2.0 -I/cygdrive/c/cygwin/usr/include/libgnomeui-2.0 -I/cygdrive/c/cygwin/usr/include/libgnome-2.0 -I/cygdrive/C/cygwin/usr/include/libbonobo-2.0 -I/cygdrive/C/cygwin/usr/include/libbonoboui-2.0 -I/cygdrive/C/cygwin/usr/include/libart-2.0 -I/cygdrive/C/cygwin/usr/include/gnome-vfs-2.0 -I/cygdrive/c/cygwin/usr/lib -std=c99  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/626565074/myModule.o /cygdrive/C/Users/test/Documents/NetBeansProjects/myModule/myModule.c
